...
\end{minipage}\]
\textbf{Good to Know}: En el dibujo vemos que empieza todo desde el índice 1 pero en realidad empezamos desde el 0. \textbf{Lo que todavía no entiendo es, qué pasaría si los nodos guardan información compleja, como elijo cual va en el índice 0, cual en el 1, etc.} \\

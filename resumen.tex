...
\begin{itemize}
    ...
    \item Caso recursivo: Es un estado que \textbf{sí} realiza llamadas recursivas.
    \item Transición: Cómo se combinan los resultados de los subproblemas para obtener la solución. 
\end{itemize}

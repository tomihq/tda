...
\begin{itemize}
    ...
    \end{itemize}
    \item Soluciones candidatas: Serían las hojas del árbol, es decir, todas las posibles respuestas. 
    \item Soluciones válidas: Son aquellas soluciones que cumplen con todas las características que buscamos (las hojas que cumplan).
\end{itemize}
\subsection*{Podas}
...
\begin{itemize}
    ...
    \begin{itemize}
        \item Digamos que quiero llegar a armar subconjuntos que sumen 9, si con el nodo actual la suma es 10, entonces no me sirve seguir hacia adelante. Podo de una.
    \end{itemize}
